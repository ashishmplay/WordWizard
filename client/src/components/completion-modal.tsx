...
import { Trophy, Mic, MicOff } from "lucide-react";
    ...
    <Dialog open={show}>
      <DialogContent className="bg-white rounded-3xl p-8 sm:p-12 max-w-lg mx-4 text-center border-none">
        ...
        <Button
          ...
          size="lg"
          className="bg-child-blue hover:bg-blue-600 text-white px-8 py-4 rounded-2xl text-xl font-bold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
        >
          Start New Session
        </Button>
      </DialogContent>
